...
def plotFigure(score_data=None,release=True):
    ...
    fig.text(-0.05,1.05,"a",fontsize=15,fontweight="bold",va="top",transform=fig.transAxes)
    pl.text(2.5,1.02,"VariBenchSelected",fontsize=11,fontweight="bold")
    remove_border()
    ...
    pl.ylabel("AUC")
    pl.xticks(sp.arange(7),['All','Pure',']0.0,1.0[','[0.1,0.9]','[0.2,0.8]','[0.3,0.7]','[0.4,0.6]',],fontsize=font_size,rotation=90)
    fig.text(-0.05,1.05,"b",fontsize=15,fontweight="bold",va="top",transform=fig.transAxes)
    pl.text(2.5,0.94,"predictSNPSelected",fontsize=11,fontweight="bold")
    remove_border()
    ...
    pl.xticks(sp.arange(7),['All','Pure',']0.0,1.0[','[0.1,0.9]','[0.2,0.8]','[0.3,0.7]','[0.4,0.6]',],fontsize=font_size,rotation=90)
    remove_border()
    fig.text(-0.05,1.05,"c",fontsize=15,fontweight="bold",va="top",transform=fig.transAxes)
    pl.text(2.5,0.94,"SwissVarSelected",fontsize=11,fontweight="bold")
    
    pl.subplots_adjust(left=0.06,bottom=0.11,right=0.98,top=0.91,wspace=0.03,hspace=0.45)
    
    if release:
        pl.savefig(os.path.abspath('Output/Figures/Figure3.tiff'),dpi=300)
    else:
        pl.savefig(os.path.abspath('Output/Figures/Figure3.pdf'))
        pl.savefig(os.path.abspath('Output/Figures/Figure3.tiff'),dpi=300)
        pl.savefig(os.path.abspath('Output/Figures/Figure3.jpg'))
    pl.close()
